...
export function CTASection() {
    return (
        <SectionWrapper label="Download" labelColor="pink" showDivider={true} id="download">
                        ...
                        <div className="relative z-10">
                            <div className="max-w-2xl mx-auto text-center mb-12">
                                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white mb-6">
                                    Ready to simplify your MCP workflow?
                                </h2>
                                <p className="text-lg text-gray-300 dark:text-gray-400 leading-relaxed">
                                    Download Relay for free and start managing your MCP servers in minutes.
